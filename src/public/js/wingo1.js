...
$.ajax({
    ...
    if (firstGame && firstGame.stage === list_orders[0].period) {
        ...
        if (firstGame.get == 0) {
            ...
            myModal_result.innerHTML = "- ₹ " + new Intl.NumberFormat().format(firstGame.money);
        } else {
            myModalheader.innerHTML = "Congratulations";
            myModal_result.innerHTML = "+ ₹ " + new Intl.NumberFormat().format(firstGame.get);
        }
...
function totalMoney() {
  ...
  $(".foot .right span:eq(1)").text(new Intl.NumberFormat().format(total) + "");
}
  ...
  $("body").append(
    `
                <div data-v-1dcba851="" class="msg">
                    <div data-v-1dcba851="" class="msg-content v-enter-active v-enter-to" > ${msg} </div>
                </div>
                `
  );
  setTimeout(() => {
...
$(".foot .right").click(function (e) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      $(".total-box .num span").text("₹ " + new Intl.NumberFormat().format(response.money) + ".00");
                                ...
                                <div data-v-a9660e98="" class="money">
                                        ${
                                          list_orders.status==1 && list_orders.bet ==0 
                                            ...
                                            new Intl.NumberFormat().format(list_orders.money * 4.5) +
                                              " </span>"
                                            ...
                                            ? '<span data-v-a9660e98="" class="success"> + ' +
                                            new Intl.NumberFormat().format(list_orders.money * 1.5) +
                                            " </span>"
                                            : list_orders.status==1 && list_orders.bet == 'd'
                                            ? '<span data-v-a9660e98="" class="success"> + ' +
                                            new Intl.NumberFormat().format(list_orders.money * 2) +
                                            " </span>"
                                            ...
                                            : list_orders.status==1
                                            ?'<span data-v-a9660e98="" class="success"> + ' +
                                            new Intl.NumberFormat().format(list_orders.money * 9) +
                                            " </span>"
                                            : list_orders.status == 2
                                            ? '<span data-v-a9660e98="" class="fail"> - ' +
                                              new Intl.NumberFormat().format(list_orders.money) +
                                              "</span>"
                                            : ""
                                        }
                                </div>
