...
function reload_money() {
    fetch("/api/webapi/GetUserInfo")
        ...
        .then((data) => {
            ...
            $(".num span").text(`₹ ${ new Intl.NumberFormat().format(data.data.money_user)}.00  `);
            $('.Loading').fadeOut(0);
        });
}
reload_money();
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status == true) {
                $('#money_show').text("₹ " + new Intl.NumberFormat().format(response.money) + '.00');
                showMeJoin();
            }
        }
    });
      ...
      <div data-v-42f27458="" issuenumber="${data.id_product}" addtime="${timerJoin(data.time)}" rowid="1" class="hb">
          <div data-v-42f27458="" class="item c-row">
              <div data-v-42f27458="" class="c-row c-row-between info">
                  ...
                  <div data-v-42f27458="" class="money" style="display: ${(data.status == 0) ? 'none' : ''}">
                      <span data-v-42f27458="" class="${(data.status == 1) ? 'success' : 'fail'}"> ${(data.status == 1) ? '+' : '-'} ${(data.status == 1) ? data.get : new Intl.NumberFormat().format(data.price)}.00</span>
                      <!---->
                  </div>
              </div>
          </div>
          <div data-v-42f27458="" class="details display-none">
              ...
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  ...
                  <div data-v-42f27458="">${new Intl.NumberFormat().format(data.money)}.00</div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  <div data-v-42f27458="">Quantity Purchased</div>
                  <div data-v-42f27458="">${new Intl.NumberFormat().format(data.amount)}</div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  <div data-v-42f27458="">After Tax Amount</div>
                  <div data-v-42f27458="" class="red">${new Intl.NumberFormat().format(data.price)}.00</div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  <div data-v-42f27458="">Tax</div>
                  <div data-v-42f27458="">${new Intl.NumberFormat().format(data.fee)}.00</div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
              ...
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  ...
                  <div data-v-42f27458="" class="${(data.status == 1) ? 'green' : 'red'}" style="display: ${(data.status == 0) ? 'none' : ''};">${(data.status == 1) ? '+' : '-'} ${(data.status == 1) ? data.get :new Intl.NumberFormat().format( data.price)}.00</div>
                  <!---->
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
